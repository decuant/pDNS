...
-- ----------------------------------------------------------------------------
-- format a message to look at
--
function Trace.showerr(self, inText, inParam)
	
	inParam = inParam or "<nil>"
	
	self:line(_cat({"ℹ ", inText, ": ", tostring(inParam)}, ""))
end
...
-- ----------------------------------------------------------------------------
--
function Trace.endsummary(self)
